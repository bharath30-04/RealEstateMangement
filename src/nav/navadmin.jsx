      ...
      <div className="cont">
        ...
        <div className="nav">
            ...
            <ul>
              ...
              <li><Link to="/admin/agents" className="link">Agents</Link></li>
              <li><Link to="/admin/addagent" className="link">Add Agent</Link></li>
              <li><Link to="/admin/addproperty" className="link">Add Property</Link></li>
